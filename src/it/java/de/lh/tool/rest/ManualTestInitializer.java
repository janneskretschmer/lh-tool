	...
	public void initializeDatabaseForManualTests() throws IOException {
		assertTrue(testEndpoint(EndpointTest.builder()//
				.initializationQueries(List.of(
						"INSERT INTO `helper_type` (`id`, `name`) VALUES (1, 'Test1'), (2, 'Test2'), (3, 'Test3');",
						...
						"INSERT INTO `item` (`id`, `slot_id`, `identifier`, `has_barcode`, `name`, `description`, `quantity`, `unit`, `width`, `height`, `depth`, `outside_qualified`, `consumable`, `broken`, `picture_url`, `technical_crew_id`) VALUES (1, 1, 'Identifier1', 0, 'Item1', 'Description 1', 1, 'Stück', 12, 24, 48, 1, 1, 1, 'Url1', 1), (2, 1, 'GJYRS2YDV', 1, 'Test2', 'Der zweite Testgegenstand, z.B. Schrauben oder sowas. Halt irgendwas, was man verbrauchen kann und eine etwas längere Beschreibung hat, damit man mal sieht, wie das aussieht. Deswegen besteht sie aus drei Sätzen, auch wenn es eigentlich viel kürzer gehen würde.', 100, 'Stück', 10, 25, 30, 0, 1, 0, '', 2);",
