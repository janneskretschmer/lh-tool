                        ...
                        if (needs) {
                            day.content = (
                                <>
                                    ...
                                    <div className={classes.applyWrapper}>
                                        <NeedApplyEditComponent need={needs.get('GATEKEEPER_MORNING')} label="Pförtner Vormittag" />
                                        <NeedApplyEditComponent need={needs.get('GATEKEEPER_AFTERNOON')} label="Pförtner Nachmittag" />
                                    </div>
                                    <div className={classes.applyWrapper}>
