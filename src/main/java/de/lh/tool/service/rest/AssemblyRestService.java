...
public class AssemblyRestService {
	...
	public Map<String, AssembledHelperTypeWrapperDto> getAssembledNeedsForCalendarBetweenDates(
		...
		return dtoAssemblyService.findHelperTypesWithNeedsAndUsersBetweenDates(projectId, start, end);
	}
