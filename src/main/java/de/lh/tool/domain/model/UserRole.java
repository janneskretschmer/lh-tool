...
//	Unfortunately granted authorities always have to start with "ROLE_". Several attempts to change that failed. 	
	public static final String RIGHT_USERS_GET = "ROLE_RIGHT_USERS_GET";
	public static final String RIGHT_USERS_GET_BY_ID = "ROLE_RIGHT_USERS_GET_BY_ID";
	public static final String RIGHT_USERS_GET_FOREIGN = "ROLE_RIGHT_USERS_GET_FOREIGN";
	...
	public static final String RIGHT_PROJECTS_HELPER_TYPES_GET = "ROLE_RIGHT_PROJECTS_HELPER_TYPES_GET";
	public static final String RIGHT_PROJECTS_HELPER_TYPES_POST = "ROLE_RIGHT_PROJECTS_HELPER_TYPES_POST";
	public static final String RIGHT_PROJECTS_HELPER_TYPES_PUT = "ROLE_RIGHT_PROJECTS_HELPER_TYPES_PUT";
	public static final String RIGHT_PROJECTS_HELPER_TYPES_DELETE = "ROLE_RIGHT_PROJECTS_HELPER_TYPES_DELETE";
	...
	public static final String RIGHT_NEEDS_GET_FOREIGN_USER = "ROLE_RIGHT_NEEDS_GET_FOREIGN_USER";
	...
	public static final String RIGHT_ITEMS_DELETE = "ROLE_RIGHT_ITEMS_DELETE";
	...
	public static final String RIGHT_ITEMS_NOTES_POST = "ROLE_RIGHT_ITEMS_NOTES_POST";
	public static final String RIGHT_ITEMS_NOTES_DELETE = "ROLE_RIGHT_ITEMS_NOTES_DELETE";
	public static final String RIGHT_ITEMS_NOTES_DELETE_FOREIGN = "ROLE_RIGHT_ITEMS_NOTES_DELETE_FOREIGN";

	public static final String RIGHT_ITEM_TAGS_GET = "ROLE_RIGHT_ITEM_TAGS_GET";
...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_ADMIN, List.of(//
					...
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID, RIGHT_PROJECTS_POST, RIGHT_PROJECTS_DELETE,
					RIGHT_PROJECTS_PUT, RIGHT_PROJECTS_CHANGE_FOREIGN, RIGHT_PROJECTS_USERS_GET,
					RIGHT_PROJECTS_USERS_DELETE, RIGHT_PROJECTS_USERS_POST, RIGHT_PROJECTS_USERS_GET_FOREIGN,
					RIGHT_PROJECTS_USERS_CHANGE_FOREIGN, RIGHT_PROJECTS_HELPER_TYPES_GET,
					...
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID, RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_DELETE,
					...
					RIGHT_ITEMS_PATCH_QUANTITY, RIGHT_ITEM_TAGS_GET, RIGHT_ITEMS_DELETE,
					// \\ // \\ // \\ // \\ // \\ // \\ // \\
			...
			roleRights.put(ROLE_CONSTRUCTION_SERVANT, List.of(RIGHT_USERS_GET, RIGHT_USERS_GET_BY_ID,
					RIGHT_USERS_GET_FOREIGN, RIGHT_USERS_CREATE, RIGHT_USERS_PUT, RIGHT_USERS_DELETE,
					RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID, RIGHT_PROJECTS_POST, RIGHT_PROJECTS_PUT,
					RIGHT_PROJECTS_USERS_GET, RIGHT_PROJECTS_USERS_DELETE, RIGHT_PROJECTS_USERS_POST,
					RIGHT_PROJECTS_HELPER_TYPES_GET, RIGHT_PROJECTS_HELPER_TYPES_POST, RIGHT_PROJECTS_HELPER_TYPES_PUT,
					RIGHT_PROJECTS_HELPER_TYPES_DELETE,
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					...
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID, RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_DELETE,
					RIGHT_NEEDS_CHANGE_FOREIGN_USER, RIGHT_NEEDS_GET_FOREIGN_USER, RIGHT_NEEDS_USERS_PUT,
			...
			roleRights.put(ROLE_LOCAL_COORDINATOR, List.of(RIGHT_USERS_GET, RIGHT_USERS_GET_BY_ID,
					...
					RIGHT_NEEDS_GET_FOREIGN_USER, RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_APPLY,
					RIGHT_NEEDS_APPROVE, RIGHT_NEEDS_VIEW_APPROVED));

			roleRights.put(ROLE_ATTENDANCE,
					List.of(RIGHT_USERS_GET_BY_ID, RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID,
							RIGHT_PROJECTS_HELPER_TYPES_GET, RIGHT_HELPER_TYPES_GET, RIGHT_HELPER_TYPES_GET_BY_ID,
							RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID, RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_USERS_PUT,
							RIGHT_NEEDS_GET_FOREIGN_USER, RIGHT_NEEDS_APPLY, RIGHT_NEEDS_VIEW_APPROVED));

			roleRights.put(ROLE_PUBLISHER,
					List.of(RIGHT_USERS_GET_BY_ID, RIGHT_USERS_PUT, RIGHT_PROJECTS_GET, RIGHT_PROJECTS_HELPER_TYPES_GET,
							RIGHT_HELPER_TYPES_GET, RIGHT_HELPER_TYPES_GET_BY_ID, RIGHT_NEEDS_USERS_GET,
							RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_APPLY, RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID));
			roleRights.put(ROLE_STORE_KEEPER, List.of(RIGHT_USERS_GET_BY_ID, RIGHT_USERS_PUT,
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					RIGHT_SLOTS_GET, RIGHT_SLOTS_GET_BY_ID,
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
