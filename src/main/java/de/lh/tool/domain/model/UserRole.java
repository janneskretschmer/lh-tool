...
//	Unfortunately granted authorities always have to start with "ROLE_". Several attempts to change that failed. 	
	...
	public static final String RIGHT_USERS_CHANGE_ROLES = "ROLE_RIGHT_USERS_ALTER_ROLES";
...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_ADMIN, List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_CREATE, RIGHT_USERS_DELETE,
					...
					RIGHT_PROJECTS_GET_BY_ID, RIGHT_PROJECTS_POST, RIGHT_PROJECTS_DELETE, RIGHT_PROJECTS_PUT,
					RIGHT_PROJECTS_USERS_DELETE, RIGHT_PROJECTS_USERS_PUT, RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID,
					RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_USERS_GET));
