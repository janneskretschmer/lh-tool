...
//	Unfortunately granted authorities always have to start with "ROLE_". Several attempts to change that failed. 	
	...
	public static final String RIGHT_NEEDS_APPLY_AND_WITHDRAW = "ROLE_RIGHT_NEEDS_APPLY_AND_WITHDRAW";
	public static final String RIGHT_NEEDS_ACCEPT_AND_DECLINE = "RIGHT_NEEDS_ACCEPT_AND_DECLINE";
...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_ADMIN, List.of(//
					...
					RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_APPLY_AND_WITHDRAW,
					RIGHT_NEEDS_ACCEPT_AND_DECLINE));
			...
			roleRights.put(ROLE_LOCAL_COORDINATOR,
					List.of(RIGHT_PROJECTS_GET_BY_ID, RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_GET,
							...
							RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_ACCEPT_AND_DECLINE));

			roleRights.put(ROLE_SERVICE_COMMITTEE, List.of());
			roleRights.put(ROLE_PUBLISHER, List.of(RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_APPLY_AND_WITHDRAW));
