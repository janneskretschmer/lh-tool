...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_CONSTRUCTION_SERVANT, List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_GET_BY_ID, RIGHT_USERS_CREATE, RIGHT_USERS_PUT,
			...
			roleRights.put(ROLE_LOCAL_COORDINATOR,
					List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_GET_BY_ID, RIGHT_USERS_CREATE, RIGHT_USERS_PUT, RIGHT_USERS_GRANT_ROLE_PUBLISHER,
