...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_CONSTRUCTION_SERVANT,
					List.of(RIGHT_USERS_GET, RIGHT_USERS_GET_BY_ID, RIGHT_USERS_GET_FOREIGN, RIGHT_USERS_CREATE,
							...
							RIGHT_PROJECTS_USERS_DELETE, RIGHT_PROJECTS_USERS_POST, RIGHT_PROJECTS_HELPER_TYPES_GET,
							RIGHT_PROJECTS_HELPER_TYPES_POST, RIGHT_PROJECTS_HELPER_TYPES_PUT,
							RIGHT_PROJECTS_HELPER_TYPES_DELETE,
							// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
			...
			roleRights.put(ROLE_ATTENDANCE,
					List.of(RIGHT_USERS_GET_BY_ID, RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID, RIGHT_PROJECTS_HELPER_TYPES_GET, RIGHT_HELPER_TYPES_GET,
							RIGHT_HELPER_TYPES_GET_BY_ID, RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID, RIGHT_NEEDS_USERS_GET,
							RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_APPLY, RIGHT_NEEDS_VIEW_APPROVED));
