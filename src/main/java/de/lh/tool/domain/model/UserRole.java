...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_LOCAL_COORDINATOR, List.of(RIGHT_USERS_GET, RIGHT_USERS_GET_BY_ID,
					...
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
					RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID, RIGHT_PROJECTS_USERS_POST,
					// \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\ // \\
			...
			roleRights.put(ROLE_ATTENDANCE,
					List.of(RIGHT_USERS_GET, RIGHT_USERS_GET_BY_ID, RIGHT_USERS_GET_FOREIGN, RIGHT_USERS_PUT,
							RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID, RIGHT_HELPER_TYPES_GET,
			...
			roleRights.put(ROLE_PUBLISHER,
					List.of(RIGHT_USERS_GET_BY_ID, RIGHT_USERS_PUT, RIGHT_PROJECTS_GET, RIGHT_HELPER_TYPES_GET,
							RIGHT_HELPER_TYPES_GET_BY_ID, RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_USERS_PUT,
