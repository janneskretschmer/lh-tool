...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_CONSTRUCTION_SERVANT,
					List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_CREATE, RIGHT_PROJECTS_GET, RIGHT_PROJECTS_GET_BY_ID,
							RIGHT_PROJECTS_POST, RIGHT_PROJECTS_PUT, RIGHT_PROJECTS_USERS_DELETE,
							RIGHT_PROJECTS_USERS_POST, RIGHT_USERS_GRANT_ROLE_INVENTORY_MANAGER,
							RIGHT_USERS_GRANT_ROLE_LOCAL_COORDINATOR, RIGHT_USERS_GRANT_ROLE_PUBLISHER,
							RIGHT_USERS_GRANT_ROLE_STORE_KEEPER, RIGHT_NEEDS_GET, RIGHT_NEEDS_GET_BY_ID,
							RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_DELETE, RIGHT_NEEDS_CHANGE_FOREIGN_USER,
							RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_APPROVE));

			roleRights.put(ROLE_LOCAL_COORDINATOR,
					List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_CREATE, RIGHT_USERS_GRANT_ROLE_PUBLISHER,
