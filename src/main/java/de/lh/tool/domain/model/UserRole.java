...
//  _╚═════╝_╚═╝__╚═╝╚═╝__╚═╝╚═╝__╚═══╝___╚═╝___╚═╝╚═╝__╚═══╝_╚═════╝_
			...
			roleRights.put(ROLE_LOCAL_COORDINATOR,
					List.of(RIGHT_USERS_GET_ALL, RIGHT_USERS_CREATE, RIGHT_USERS_PUT, RIGHT_USERS_GRANT_ROLE_PUBLISHER,
							RIGHT_PROJECTS_GET_BY_ID, RIGHT_NEEDS_POST, RIGHT_NEEDS_PUT, RIGHT_NEEDS_GET,
			...
			roleRights.put(ROLE_PUBLISHER, List.of(RIGHT_NEEDS_USERS_GET, RIGHT_NEEDS_USERS_PUT, RIGHT_NEEDS_APPLY, RIGHT_NEEDS_GET));
